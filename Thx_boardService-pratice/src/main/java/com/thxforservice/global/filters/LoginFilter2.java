...
// * JWT 기반 로그인 필터
// *
// * 이 필터는 클라이언트의 요청에서 JWT 토큰을 추출하여 사용자 인증을 수행하는 역할
// *
// * 1. 요청에서 JWT 토큰을 추출
...
// *
// * JWT 사용 시 유의할 점:
// * - 토큰은 반드시 HTTPS를 통해 전달 (HTTP 전송 시 가로채기 위험)
// * - 토큰은 적절한 만료 시간(exp)을 설정
// * - 서버는 토큰을 검증하고, 권한을 적절히 부여해
// * - 민감한 정보는 토큰에 직접 포함하지 말고, 최소한의 정보만 담아야함
// */
//@Component
